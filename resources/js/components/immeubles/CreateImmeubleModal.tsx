...
interface CreateImmeubleModalProps {
    isOpen: boolean;
    onClose: () => void;
...
const CreateImmeubleModal: React.FC<CreateImmeubleModalProps> = ({
    isOpen,
    onClose,
    onSave,
    defaultTerrainId,
    ...
    const resetForm = () => {
        ...
        // Reset file input manually if needed, though refreshing the component tree usually handles it
    };
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        if (formData.terrain_id) data.append("terrain_id", formData.terrain_id);
        if (formData.nombre_etages)
            data.append("nombre_etages", formData.nombre_etages);
        data.append("statut", formData.statut);
        if (formData.date_debut) data.append("date_debut", formData.date_debut);
...
export default CreateImmeubleModal;
